<?php
	...
	Class eventsave_project extends Event{
		
		const ROOTELEMENT = 'save-project';
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2010-03-10T17:30:33+00:00',
...
&lt;/form></code></pre>
		...
		public function load(){			
			if(isset($_POST['action']['save-project'])) return $this->__trigger();
		}
